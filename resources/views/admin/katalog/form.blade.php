...
<div class="label">
    ...
    <input class="input input-bordered w-full max-w-xs" name="produk_id" type="number" id="produk_id" value="{{ isset($katalog->produk_id) ? $katalog->produk_id : ''}}" >
...
<div class="label">
    ...
    <input class="input input-bordered w-full max-w-xs" name="katalog" type="text" id="katalog" value="{{ isset($katalog->katalog) ? $katalog->katalog : ''}}" >
