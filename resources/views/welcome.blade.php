                 ...
                 <div class="max-w-md carousel rounded-box">
                     @for ($i = 7; $i < 14; $i ++)
                         <div class="carousel-item w-full">
                           <img src="{{asset('image/img ('.$i.').jpeg')}}" class="w-full" alt="Tailwind CSS Carousel component" />
                         </div>
                     @endfor
                   </div>
                 <div class="text-center">
                     <img src="{{asset(''. $profile->logo .'')}}" class="drop-shadow-lg shadow-white" class="w-1/2" alt="" srcset="">
